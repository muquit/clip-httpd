...
Please see the **Installation** section in [README.md](README.md#installation) for installation and checksum verification instructions.
...
|---------|----------|--------------|-------|
| cbcopy-v1.0.2-darwin-amd64.d.tar.gz | macOS | x86_64 | |
| cbcopy-v1.0.2-darwin-arm64.d.tar.gz | macOS | ARM64 | |
| cbcopy-v1.0.2-linux-386.d.tar.gz | Linux | x86 (32-bit) | |
| cbcopy-v1.0.2-linux-amd64.d.tar.gz | Linux | x86_64 | |
| cbcopy-v1.0.2-linux-arm.d.tar.gz | Linux | ARM | |
...
| clip-httpd-v1.0.2-linux-arm64.d.tar.gz | Linux | ARM64 | |
| clip-httpd-v1.0.2-raspberry-pi-jessie.d.tar.gz | Linux | ARM (Pi Jessie) | |
